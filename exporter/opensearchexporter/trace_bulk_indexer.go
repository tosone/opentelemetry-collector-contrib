...
func newTraceBulkIndexer(dataset, namespace, index, bulkAction string, model mappingModel) *traceBulkIndexer {
	return &traceBulkIndexer{dataset, namespace, index, bulkAction, model, nil, nil}
}
